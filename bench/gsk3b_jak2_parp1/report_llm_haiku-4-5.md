# Extraction benchmark: gsk3b_jak2_parp1 — method: llm (claude-haiku-4-5-20251001, $0.3475)

24 open-access papers curated by ChEMBL; targets: GSK3B, JAK2, PARP1.

| metric | value |
|---|---|
| extracted values | 168 |
| ChEMBL reference values | 184 |
| matched | 100 |
| precision | 59.5% |
| recall (all ChEMBL values) | 54.3% |
| recall (values present in paper tables) | 62.7% |
