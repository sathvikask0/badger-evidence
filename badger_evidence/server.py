...
def make_server(dataset: dict, data_dir: Path = DATA, port: int = 8765) -> ThreadingHTTPServer:
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            ...
            assets = {"/": ("index.html", "text/html"), "/app.js": ("app.js", "text/javascript"), "/stats.js": ("stats.js", "text/javascript"), "/style.css": ("style.css", "text/css"), "/favicon.svg": ("favicon.svg", "image/svg+xml")}
